...
X = dataSet.data
Y = dataSet.target
X = np.reshape(X, (64, len(X)))
Y = np.reshape(Y, (1, len(Y)))

# Visualize the data:
plt.scatter(X[0, :], X[1, :], s=80, cmap=plt.cm.Spectral)
plt.savefig("Figures/LoadedData.jpg")
...
parameters = initialize_parameters(64, 4, 10)
...
hidden_layer_sizes = [1, 2, 3, 4, 8, 16, 64, 128]
